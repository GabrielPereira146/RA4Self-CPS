...
public class ControlPanel extends javax.swing.JFrame {
                                                ...
                                                .addGroup(jPanel7Layout.createSequentialGroup()
                                                                ...
                                                                .addGroup(jPanel7Layout
                                                                                .createParallelGroup(
                                                                                                ...
                                                                                                false)
                                                                                .addComponent(jPanelTemperature,
                                                                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                                                Short.MAX_VALUE)
                                                                                .addComponent(jPanelBloodPressure,
                                                                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                                                Short.MAX_VALUE)
                                                                                .addComponent(jPanelPulseOxygen,
                                                                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                                                Short.MAX_VALUE)
                                                                                .addGroup(jPanel7Layout
                                ...
                                jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                .addGroup(jPanel9Layout.createSequentialGroup()
                                                                ...
                                                                .addGroup(jPanel9Layout.createParallelGroup(
                                                                                javax.swing.GroupLayout.Alignment.LEADING)
                                                                                .addComponent(jPanelAirFlow,
                                                                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                                                Short.MAX_VALUE)
                                                                                .addComponent(jPanelHeartRate,
                                                                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                                                Short.MAX_VALUE)
                                                                                .addComponent(jPanelGlucose,
                                                                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                                                Short.MAX_VALUE))
                                                                .addContainerGap()));
        ...
        private void jSSystolicBPStateChanged(javax.swing.event.ChangeEvent evt) {// GEN-FIRST:event_jSSystolicBPStateChanged
                try {
                        ...
                        int value2 = (int) jSDiastolicBP.getValue();
                        System.out.println("Systolic Blood Pressure Value: " + value);
                        setSBPValue(value, value2);
                } catch (IOException ex) {
                        Logger.getLogger(ControlPanel.class.getName()).log(Level.SEVERE, null, ex);
                }
        ...
        private void jSDiastolicBPStateChanged(javax.swing.event.ChangeEvent evt) {// GEN-FIRST:event_jSDiastolicBPStateChanged
                try {
                        ...
                        int value2 = (int) jSSystolicBP.getValue();
                        System.out.println("Diastolic Blood Pressure Value: " + value);
                        setDBPValue(value, value2);
                } catch (IOException ex) {
                        Logger.getLogger(ControlPanel.class.getName()).log(Level.SEVERE, null, ex);
                }
        ...
        private static void setDBPValue(int diastolic, int systolic) throws IOException {
                String URL = "http://localhost:8084/shhc/BloodPressure/update";
                BloodPressure bPressure = new BloodPressure(diastolic, systolic, "Online", "1");
                String json = GsonUtils.objetoToJson(bPressure);
                CustomHttpClientUtils.setValueByHttpPut(URL, json);
        }

        private static void setSBPValue(int systolic, int diastolic) throws IOException {
                String URL = "http://localhost:8084/shhc/BloodPressure/update";
                BloodPressure bloodP = new BloodPressure(diastolic, systolic, "Online", "1");
